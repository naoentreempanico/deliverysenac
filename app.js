const cardapioUl = document.getElementById('cardapio');//<ul id="cardapio"></ul>More actions
...
formCadastro.addEventListener('submit', (evento) => {
    ...
    let novaPizza = {
        foto: foto,
        nome: nome,
        ingredientes: ingredientes, //[ingredientes] retirado
        valor: valor
    };
...
function removerCarrinho(indice) {
    ...
    //atualiza o carrinho após a remoçãoMore actions
    atualizarCarrinho();
}
exibirCardapio();
